<section data-bg="light" class="section clip theme_on-brand">
    <div class="container">
        <div data-video-playpause="" class="apart-info-w">
            <div class="apart-info-s">
                ...
                <div class="grid">
                    <div class="info-s_lead">
                        <h3 data-scroll-reveal="p" class="h4 a-center" style="visibility: visible;" aria-label="Residences range from 104 to 244 sq.m., offering spacious single level and duplex layouts with generous terraces and rooftop solariums."><span class="split-line-mask" aria-hidden="true" style="text-align: center; overflow: clip;"><span class="split-line" aria-hidden="true" style="text-align: center; translate: none; rotate: none; scale: none; transform: translate(0%, 110%);"><span class="split-word" aria-hidden="true">Residences</span> <span class="split-word" aria-hidden="true">range</span> <span class="split-word" aria-hidden="true">from</span> <span class="split-word" aria-hidden="true">104</span> <span class="split-word" aria-hidden="true">to</span> <span class="split-word" aria-hidden="true">244</span> <span class="split-word" aria-hidden="true">sq.m.,</span> <span class="split-word" aria-hidden="true">offering</span> </span></span><span class="split-line-mask" aria-hidden="true" style="text-align: center; overflow: clip;"><span class="split-line" aria-hidden="true" style="text-align: center; translate: none; rotate: none; scale: none; transform: translate(0%, 110%);"><span class="split-word" aria-hidden="true">spacious</span> <span class="split-word" aria-hidden="true">single</span> <span class="split-word" aria-hidden="true">level</span> <span class="split-word" aria-hidden="true">and</span> <span class="split-word" aria-hidden="true">duplex</span> <span class="split-word" aria-hidden="true">layouts</span> <span class="split-word" aria-hidden="true">with</span> </span></span><span class="split-line-mask" aria-hidden="true" style="text-align: center; overflow: clip;"><span class="split-line" aria-hidden="true" style="text-align: center; translate: none; rotate: none; scale: none; transform: translate(0%, 110%);"><span class="split-word" aria-hidden="true">generous</span> <span class="split-word" aria-hidden="true">terraces</span> <span class="split-word" aria-hidden="true">and</span> <span class="split-word" aria-hidden="true">rooftop</span> <span class="split-word" aria-hidden="true">solariums.</span></span></span></h3></div>
                </div>
                <div class="u-160"></div>
                <div class="grid">
                    <div class="info-s_desc">
                        <p data-scroll-reveal="p" class="p1 a-center" style="visibility: visible;"></p>
                        <div class="u-32"></div>
                        <div class="s_logo">
                            <div data-scroll-reveal="ctn" class="logo_symbol ico-48" style="visibility: visible; translate: none; rotate: none; scale: none; transform: translate(0px, 3.333rem); opacity: 0;">
            ...
            <div data-parallax="ctn-down" class="flower apart-info" style="translate: none; rotate: none; scale: none; transform: translate(0%, -10%) scale(1, -1);">
                ...
                class="video">
                    ...
                    <source src="https://assets.era-residence.com/flowers/bougainvillea-flowers_04.mov" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
