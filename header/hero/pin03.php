<div data-modal-tip-btn="your-private-sanctuary" data-pin="your-private-sanctuary" floating-tip-trigger="your-private-sanctuary" role="listitem" class="pins-cms_list_item w-dyn-item">
    ...
    <div class="style-css w-embed">
        <style>
            [data-pin='your-private-sanctuary'] {
                top: 73.2%;
                left: 76.6%;
                }
        </style>
