    ...
    <a hover-link="" aria-label="Select  an Apartment" href="/apartments" class="link w-inline-block">
        <div class="link_label">
            <div class="link_label_text">
                <div hover="text" class="h6" aria-label="Select an Apartment"><span class="split-line" aria-hidden="true" style="text-align: right;"><span class="split-word" aria-hidden="true"><span class="split-char" aria-hidden="true">S</span><span class="split-char" aria-hidden="true">e</span>
                    <span
                    class="split-char" aria-hidden="true">l</span><span class="split-char" aria-hidden="true">e</span><span class="split-char" aria-hidden="true">c</span><span class="split-char" aria-hidden="true">t</span></span> <span class="link_line" style="translate: none; rotate: none; scale: none; transform-origin: 100% 50% 0px; transform: translate(0px);"></span></span>
                        <span
                        class="split-line" aria-hidden="true" style="text-align: right;"><span class="split-word" aria-hidden="true"><span class="split-char" aria-hidden="true">a</span><span class="split-char" aria-hidden="true">n</span></span> <span class="split-word" aria-hidden="true"><span class="split-char" aria-hidden="true">A</span>
                            <span
                            class="split-char" aria-hidden="true">p</span><span class="split-char" aria-hidden="true">a</span><span class="split-char" aria-hidden="true">r</span><span class="split-char" aria-hidden="true">t</span><span class="split-char" aria-hidden="true">m</span>
                                <span
                                class="split-char" aria-hidden="true">e</span><span class="split-char" aria-hidden="true">n</span><span class="split-char" aria-hidden="true">t</span></span><span class="link_line" style="translate: none; rotate: none; scale: none; transform-origin: 100% 50% 0px; transform: translate(0px);"></span></span>
                </div>
            </div>
