...
<div data-preloader="" class="preloader theme_on-dark">
    <div class="preloader_ctn" >
        <div class="preloader_t">
            <div class="u-48"></div>
            <?php include 'header/loader_logo.php'; ?>
        </div>
        <div class="preloader_c">
            <div class="grid">
                <div class="preloader_title-l">
                    <div data-part="h" class="c1 a-center">Crafting <br /> Landmarks</div>
                </div>
    ...
    <div class="preloader_bg">
        <div class="preloader_bg_a">
            <img src="assets/images/preloader/preloader_bg.svg" loading="eager" alt="" class="img">
        </div>
