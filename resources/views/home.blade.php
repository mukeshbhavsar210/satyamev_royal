                                        ...
                                        @foreach($floatingTips as $tip)
                                            ...
                                            >                                                
                                                ...
                                                <div hover-pin class="pin">
                                                    ...
                                                    <div class="pin_bg">
                                                        <div data-pin-pulse class="pin_bg_pulse"
                                                            style="height:43px;width:43px;opacity:0;"></div>
            ...
            <div floating-tip="{{ $tip->category }}" role="listitem" class="floating-tip w-dyn-item">
                <div class="floating-tip-card">
                    ...
                    <div class="floating-tip-card_b">
                        <ul class="p1">
                            @foreach($projects->where('category', $tip->category) as $project)
    ...
    <div class="container">
        <div class="benefits-intro-w">
            <div class="benefits-intro-s">
                ...
                <div class="grid">
                    <div class="s_title">
                        <p data-scroll-reveal="p" class="l1 a-center">Since 1997</p>
                    </div>
                </div>
                <div class="u-96"></div>
