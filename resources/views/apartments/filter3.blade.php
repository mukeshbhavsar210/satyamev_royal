<div class="apart-s_cms_filter_item is-last">
    <div data-select="" class="filter_select">
        ...
        <div data-select="drop-down" class="filter_select_drop-down">
            <div class="filter_select_drop-down_list">
                <div data-select="item" data-sort-order="asc" data-sort-trigger="relevant" hover-select-item="" class="filter_select_drop-down_list_item is-active">
                <div hover="text" class="l1">Relevant</div>
                </div>
                <div data-select="item" data-sort-order="asc" data-sort-trigger="area" hover-select-item="" class="filter_select_drop-down_list_item">
                <div hover="text" class="l1">Smallest area</div>
                </div>
                <div data-select="item" data-sort-order="desc" data-sort-trigger="area" hover-select-item="" class="filter_select_drop-down_list_item">
                <div hover="text" class="l1">Largest area</div>
                </div>
            </div>
        </div>
</div>