<div class="apart-s_cms_filter_item">
    <div data-select="" class="filter_select">
        <div hover-nav-item-l2-trigger="" data-select="btn" class="filter_select_btn">
            <div class="l2 reg">Bedrooms</div>
                <div class="filter_select_btn_label">
                    <a hover-nav-item-l2="" href="#" class="nav-item w-inline-block">
                        <div class="nav-item_label">
                            ...
                            <div data-select="value" class="l2">All</div>
                            </div>
        ...
        <div data-select="drop-down" class="filter_select_drop-down">
            <div class="filter_select_drop-down_list">
                <div data-select="item" data-filter-group="bed" data-filter-trigger="*" hover-select-item="" class="filter_select_drop-down_list_item is-active">
                ...
                <div role="list" class="filter_select_drop-down_list w-dyn-items">
                    <div role="listitem" class="cms_list_item w-dyn-item">
                        <div data-select="item" data-filter-group="bed" data-filter-trigger="2" hover-select-item="" class="filter_select_drop-down_list_item">
                            <div hover="text" class="l1">2</div>
                        </div>
                    </div>
                    <div role="listitem" class="cms_list_item w-dyn-item">
                        <div data-select="item" data-filter-group="bed" data-filter-trigger="3" hover-select-item="" class="filter_select_drop-down_list_item">
                            <div hover="text" class="l1">3</div>
                        </div>
                    </div>
                </div>
                </div>
