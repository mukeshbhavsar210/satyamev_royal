...
<main data-barba-namespace="home" data-barba="container" class="transition-container" data-bg="">
                                    ...
                                    <div role="list" class="pins-cms_list w-dyn-items">
                                        <div class="pins-cms_list">
                                            @foreach($floatingTips as $tip)
                                                <div
                                                    data-modal-tip-btn="{{ $tip->category }}"
                                                    data-pin="{{ $tip->category }}"
                                                    floating-tip-trigger="{{ $tip->category }}"
                                                    role="listitem"
                                                    @class([
                                                        'pins-cms_list_item',
                                                        'w-dyn-item',
                                                        'ongoing' => $tip->category === 'ongoing',
                                                        'upcoming' => $tip->category === 'upcoming',
                                                        'completed' => $tip->category === 'completed',
                                                    ])
                                                >
    ...
    <div class="floating-tips w-dyn-list">
        <div role="list" class="floating-tips_list w-dyn-items">
            @foreach($floatingTips as $tip)
                <div floating-tip="{{ $tip->category }}" role="listitem" class="floating-tip w-dyn-item">
                    <div class="floating-tip-card">
                        <div class="floating-tip-card_t">
                            <h1 class="h5">{{ $tip->category }}</h1>
                        </div>
                        <div class="floating-tip-card_b">
                            <ul class="p1">
                                @foreach($apartments->where('category', $tip->category) as $value)
                                    <li>{{ $value->apartment_name }}</li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="benefit-slide">
                                            ...
                                            <div class="benefit-slide_b">                                                
                                                <div class="benefit-slide_desc">
                                                    ...
                                                    <p data-scroll-reveal="p" data-slider="p" class="p1 a-center">Location: {{ $value->project->location }}</p>
                                                </div>                                                
                                            </div>                                            
                                        </div>
                                    </div>
